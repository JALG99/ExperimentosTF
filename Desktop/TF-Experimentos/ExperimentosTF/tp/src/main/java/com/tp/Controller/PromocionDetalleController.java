...
public class PromocionDetalleController implements Serializable{
   ...
   public String newPromocionDetalle(){
    ...
    public void savePromocionDetalle(){
    	...
    	int preciototalnuevo = ((promocion.getProducto().getPrecioproducto())*promocion.getCantidad()) - 10;
    	promocion.getPromocion().setPreciototal(promocion.getPromocion().getPreciototal()+preciototalnuevo);
