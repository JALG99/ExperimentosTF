...
public class DetalleController implements Serializable{
   ...
   public String newDetalle(){
    ...
    public void saveDetalle(){
    	...
    	int preciototalnuevo = ((detalle.getProducto().getPrecioproducto())*detalle.getCantidad());
  	  	detalle.getOrden().setPreciototal(detalle.getOrden().getPreciototal()+preciototalnuevo);
